...
// 图鉴卷数据：en → 中文名 / 精灵图 / 获得方式（卷数动态读 cat-vols，文件名 data-vN）
const VOLS = require('../utils/cat-vols.js')
const batchZh = {}, batchIco = {}, batchObt = {}
;Array.from({ length: VOLS }, (x, k) => k + 1).forEach(v => {
  try {
    require('../pkg-cat-' + v + '/data/data-v' + v + '.js').forEach(x => {
