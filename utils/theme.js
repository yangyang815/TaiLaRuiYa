...
const THEMES = [
  ...
  { id: "hallow", scene: {"sky":"linear-gradient(180deg,#F0C8F0 0%,#FDF6E8 75%)","ground":"#E8C8E0","dot":"#C868B8","orb":"#FFD8F0"}, name: "神圣之地", en: "Hallow", desc: "彩虹与珍珠铺成的圣洁国度。", locked: true, swatch: ["#F5EAF5", "#FDF8FD", "#B85CA8"] },
