...
Page({
  ...
  onShareAppMessage () {
    return { title: '泰拉瑞亚全物品图鉴 · 卷2（plunder items / furniture）', path: '/' + ROOT + '/pages/index/index' }
  },
  onShareTimeline () {
    return { title: '泰拉瑞亚全物品图鉴 · 卷2（plunder items / furniture）' }
  }
})
